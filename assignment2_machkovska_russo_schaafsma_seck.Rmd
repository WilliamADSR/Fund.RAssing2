...
In this assignment we will do an exploratory analysis on the variables that could predict heart disease. Consequently, we will not work with hypothesis. Since we will try to build a model by exploratory means, our research question states:
