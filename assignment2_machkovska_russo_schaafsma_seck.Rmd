...
Now we will start working with the test set. We will make predictions plugging our best model *fit10* to the test set in the probability scale. 
We will use the 50% probability as the cut off. If the probability of success is higher than 50%, you are predicted to be in the success group; if it is lower or equal to 50% you are predicted to be in the failure group.
```{r}
