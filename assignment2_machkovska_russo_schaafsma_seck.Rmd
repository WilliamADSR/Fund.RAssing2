...
# Loading the Dataset
{
heart <- read_csv("heart.csv", col_types = cols(Age =               col_number(), RestingBP = col_number(),                    Cholesterol = col_number(), FastingBS =                    col_double(), RestingECG = col_character(),               MaxHR = col_number(), ExerciseAngina =                     col_character(), Oldpeak = col_number(),                   ST_Slope = col_character(), HeartDisease =                 col_double()))
