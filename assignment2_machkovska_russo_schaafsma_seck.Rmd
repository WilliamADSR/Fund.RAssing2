...
By the criterion of parsimony, it does not worth to add complexity to the model, if the decrease in the deviance is not significant.
By this comparison criterion, *Age* should not be added and, therefore, *fit3* is the best for now. 
...
```
BIC follows the same narrative as AIC and, therefore, *fit3* is the best.  
```{r}
...
```{r}
probab <- predict(fit3, newdata = dummy_heart, type = "response")
