...
Here we will do some descriptive analysis to search for outliers and check the distributions.
...
When inspecting the variable cholesterol we observed 172 missing values. Deleting these observations would mean a loss of nearly 20% for our data set. Therefore we first checked the correlation for cholesterol without the zeros and concluded nearly no relation between cholesterol and heart disease. Consequently, we decided to completely eliminate the variable cholesterol to save our precious data. 
